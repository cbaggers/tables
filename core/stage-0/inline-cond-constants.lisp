...
(defmethod inline-cond-const ((o ssad-write-varying) type cmp-ctx)
  (declare (ignore type))
  (with-slots (form) o
    (setf form (inline-cond-const form nil cmp-ctx))
    o))
...
(defmethod inline-cond-const ((o ssad-read-varying) type cmp-ctx)
  (declare (ignore type))
  o)

(defmethod inline-cond-const ((o ssad-read-uniform) type cmp-ctx)
  (declare (ignore type))
  o)
