...
(defmethod remove-dead ((o ssad-write-varying) cmp-ctx)
  (with-slots (form) o
    (remove-dead form cmp-ctx)
    o))
...
(defmethod remove-dead ((o ssad-read-varying) cmp-ctx) o)
(defmethod remove-dead ((o ssad-read-uniform) cmp-ctx) o)
